...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'slide-in-from-left-1.5': 'slideInFromLeft 0.7s ease-out forwards',
        'slide-in-from-left-2': 'slideInFromLeft 0.8s ease-out forwards',
        'slide-in-from-left-3.5': 'slideInFromLeft 0.9s ease-out forwards',
        'slide-in-from-left-6': 'slideInFromLeft 1.0s ease-out forwards',
        'slide-in-from-left-7': 'slideInFromLeft 1.1s ease-out forwards',
        'slide-in-from-left-8': 'slideInFromLeft 1.2s ease-out forwards',
        'slide-in-from-left-9': 'slideInFromLeft 1.3s ease-out forwards',
        'slide-in-from-left-10': 'slideInFromLeft 1.4s ease-out forwards',
        'slide-in-from-left-11': 'slideInFromLeft 1.5s ease-out forwards',
        'slide-in-from-left-12': 'slideInFromLeft 1.6s ease-out forwards',
        'slide-in-from-left-13': 'slideInFromLeft 1.7s ease-out forwards',
        'slide-in-from-left-14': 'slideInFromLeft 1.8s ease-out forwards',
