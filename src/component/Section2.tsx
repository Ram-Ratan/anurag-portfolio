    ...
    >
      <div className="flex flex-col gap-4 text-center w-full md:w-3/4 px-4">
        ...
        <p className="font-light text-sm md:text-3xl text-primary-500">
          My well{" "}
          <span className="font-extrabold text-primary">rounded perspective</span> on business metrics to{" "}
          <span className="font-extrabold text-primary">achieve growth</span> beyond the Ads dashboard
        </p>
      </div>
