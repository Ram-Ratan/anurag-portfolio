    ...
    >
      <div className="flex flex-col md:flex-row md:justify-between w-full px-4 md:px-8">
        <div className="flex flex-col gap-3 md:gap-6 text-start mb-8 md:mb-0">
          ...
          <div className="flex flex-col gap-1 md:gap-2">
            <p className="font-light text-sm sm:text-xl text-primary">
              Mobile Number:
            </p>
            <p className="font-semibold text-sm sm:text-xl text-secondary">
              +91 9930902947
        ...
        <div className="flex flex-col gap-2 md:gap-5 font-figtree text-start mb-8 md:mb-0">
          <p className="text-sm sm:text-xl font-semibold text-[#9DB0D8]">
            Site Links
          </p>
          <a
            href="#section1"
        ...
        <div className="flex flex-col gap-2 md:gap-5 text-start">
          ...
          <div
            className="flex w-fit md:w-72 h-fit sm:h-16 bg-secondary rounded-full py-2 sm:py-4 px-8 font-semibold text-sm sm:text-3xl justify-center items-center text-primary cursor-pointer transition-transform duration-300 transform hover:scale-110 hover:shadow-2xl hover:shadow-secondary"
