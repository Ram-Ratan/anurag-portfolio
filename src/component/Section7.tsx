...
const Section7 = () => {
  return (
    <section id='section7' className="flex bg-primary h-fit py-10 md:py-24 w-[90%] mx-auto max-w-[1280px] flex-col gap-16 justify-center items-center">
        <div className='flex flex-col gap-4'>
            <div className='flex flex-col gap-[3px] text-start'>
                <p className='font-light text-2xl  md:text-6xl text-primary-0'>What else do I offer? Apart from consistent results</p>
                <p className='font-bold text-2xl md:text-6xl text-secondary'>Peace of mind</p>
            </div>
